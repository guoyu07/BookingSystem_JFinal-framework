		...
		<tr>
			<td width="230" class="td_leftnav_top">
                <div id="main_frame_left">
                    ...
                    <div id="mgmt_nav5">
                        ...
                        <a href="mgmt_a_pwd.htm" class="a_mgmt_leftnav1" hidefocus="true">密码修改</a>
                    </div>
                </div>
			</td>
            <td class="td_leftnav_top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2a">
					<tr>
                    	<td>
                        	<span class="span_mgmt_right2_text1">密码修改</span>
						...
						<br />   	          
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td><input type="password" class="input_mgmt1" style="width:300px;" value="${msg }" name="oldPassword"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="password" class="input_mgmt1" style="width:300px;" value="" name="repeatNewPassword"/></td>
								</tr>
